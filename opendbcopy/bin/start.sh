...
# change to openDBcopy root folder
cd ..
...
OPENDBCOPY_CLASSPATH="$CLASSPATH:$runjar:$DIRNAME/lib/xerces.jar:$DIRNAME/lib/log4j-1.2.8.jar:$DIRNAME/lib/ostermillerutils_1_03_00.jar:$DIRNAME/lib/jdom.jar:$JAVAC_JAR"
...
# Setup openDBcopy sepecific properties (note memory parameters)
