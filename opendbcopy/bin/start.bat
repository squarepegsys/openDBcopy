...
set OPENDBCOPY_CLASSPATH=%CLASSPATH%;%DIRNAME%lib\opendbcopy.jar;%DIRNAME%lib\log4j-1.2.8.jar;%DIRNAME%lib\xerces.jar;%DIRNAME%lib\jdom.jar;%DIRNAME%lib\ostermillerutils_1_03_00.jar;%JAVAC_JAR%;%RUNJAR%
