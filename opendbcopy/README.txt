...
Copyright (C) 2003 Anthony Smith <smith@puzzle.ch>
...
plugins can easily be added to do whatever operation you like (see developer documentation).
...
opendbcopy allows you to create your own custom plugins. 

You define how easy or sophisticated you want to filter and migrate your data.

Please note that opendbcopy has not been developed to produce the appropriate DDL schemas such
as CREATE TABLE xyz. This job is still yours but you will find many tools (open source or commercial)
which deal with this job. Maybe a plugin to do this job will follow.
...
opendbcopy is sponsored by Puzzle ITC and the DIK VBS (Swiss Government). Puzzle ITC
is specialized in Java development using open-source software and Linux. 

Please visit Puzzle ITC at: 
http://www.puzzle.ch (german text only) or email smith@puzzle.ch. 

or the DIK VBS at:
http://www.vbs-ddps.ch/internet/vbs/de/home.html (german, french, italian text only)